...
- Кэш таксономий: TTL 30 дней + кнопка в Настройках `POST /api/categories/refresh` (**парсер HTML**, ключи не нужны).
...
| F11 | Загрузка каталога категорий **парсером** с публичных страниц (без API-ключей) | ✅ |
