...
- Нет каталогов/выбора категорий по источникам.
- Poshmark зависит от вёрстки HTML.
...
| ID | Требование | Статус |
|----|------------|--------|
| F10 | Отдельные категории **для каждого** выбранного источника в одном поиске | 📋 план утверждён к исполнению |
| F11 | Загрузка **полного** каталога категорий маркетплейсов (не короткий curated) | 📋 |
| F12 | Поля выбора категорий в create/edit **только** для выбранных источников | 📋 |
